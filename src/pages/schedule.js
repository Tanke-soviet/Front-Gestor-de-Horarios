...
const Schedule = () => {
  ...
  const checkForSessionData = async () => {
    try {
      ...
      const hasSessions = Object.values(schedule).some(
          ...
          <>
            ...
            <div className="upload-section-with-schedule">
              ...
              <p className="upload-info">
                También puedes subir una copia en PDF de tu horario
              </p>
                  ...
                  <div className="schedules-list">
                    {schedules.map((schedule) => (
                      <div key={schedule.id} className="schedule-item">
                        ...
                        <p>
                          Fecha:{" "}
                          {new Date(schedule.uploadDate).toLocaleDateString()}
                        </p>
                        <button
            ...
            {schedules.length > 0 ? (
              ...
              <>
                ...
                <div className="upload-section">
                  <p className="upload-info">
                    Para comenzar, suba su horario en formato PDF
                  </p>
